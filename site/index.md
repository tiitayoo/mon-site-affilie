...
<input type="text" id="recherche" placeholder="Rechercher un produit..." style="width:100%; padding:10px; font-size:1em; margin-bottom:15px; border:1px solid #ccc; border-radius:5px;">
...
document.getElementById('recherche').addEventListener('input', function() {
  ...
  var articles = document.querySelectorAll('#liste-articles li');
